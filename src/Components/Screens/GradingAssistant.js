...
function GradingAssistant() {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await axios.post('https://grading-ocr.onrender.com/get_student_score/', formData, {
                headers: {
    ...
    return (
        <div>
            ...
            <input type="file" onChange={(e) => handleFileUpload(e, setAnswerKeyFile)} />
            <p>Student File</p>

            <input type="file" onChange={(e) => handleFileUpload(e, setStudentAnswers)} />
